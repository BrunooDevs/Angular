...
/*importamos el arreglo de objetos de tipo cliente de clientes.json.ts
NOTA:se puede exportar por que definimos el arreglo como export en clientes.json.ts*/
...
export class ClienteService {
  ...
  private uriEndPoint:string = "http://localhost:8080/api/clientes"
 ...
 reactivo */
   ...
   */
    return this.http.get<Cliente[]>(this.uriEndPoint).pipe(
 ...
 //metodo que edita un cliente
  getCliente( id: number) : Observable<Cliente> {
    ...
    return this.http.get<Cliente>( `${this.uriEndPoint}/${id}`).pipe(
  ...
  */
  update(cliente: Cliente) : Observable<any> {
    return this.http.put<any>(`${this.uriEndPoint}/${cliente.id}`,cliente, {headers: this.httpHeaders}).pipe(
  ...
  delete (id: number) : Observable<Cliente>{
    return this.http.delete<Cliente>(`${this.uriEndPoint}/${id}`, {headers: this.httpHeaders}).pipe(
