...
export class UsuarioService {
    ...
    private uriEndPoint:string = "http://localhost:8080/api/usuarios"
   ...
   reactivo */
     ...
     */
      return this.http.get<usuario[]>(this.uriEndPoint).pipe(
    ...
    create(cliente: usuario) : Observable<any>{
   ...
   //metodo que edita un cliente
    getCliente( id: number) : Observable<usuario> {
      ...
      return this.http.get<usuario>( `${this.uriEndPoint}/${id}`).pipe(
    ...
    */
    ...
    delete (id: number) : Observable<usuario>{
      return this.http.delete<usuario>(`${this.uriEndPoint}/${id}`, {headers: this.httpHeaders}).pipe(
